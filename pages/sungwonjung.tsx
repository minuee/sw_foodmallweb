...
import SungwonMobileScreen from "components/sungwonjung/mobile/index";
import SungwonScreen from "components/sungwonjung/index";
import functions from '@utils/functions'

export default function Sungwonjung() {
